...
def get_client_fn(model_path):
    ...
    if model_path  in ['gemini-1.5-pro-001', 
    ...
    elif model_path in ['kimi-latest']:
        from .kimi import get_client_model
    elif model_name in ['Qwen3-VL-32B-Instruct',
                        'Qwen3-VL-32B-Thinking',
        ...
        from .siliconflow import get_client_model
...
def get_generate_fn(model_path):
    ...
    if model_name in [
    ...
    elif model_name in ['kimi-latest']:
        from .kimi import generate_response
    elif model_name in [
                        'GLM-4.1V-9B-Thinking',
                        'GLM-4.6V',
                        'step3',
        ...
        from .siliconflow import generate_response
    elif model_name in ['gemini-3-flash-preview']:
