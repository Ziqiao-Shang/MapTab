...
def build_metromap_queries(task, subtask, base_dir):
    """
    ...
    # metromap 的 subtask 选项
    if subtask == "shortest_path_only_tab":
        data_file = os.path.join(base_dir, "metromap", "data", "test_set", "metromap_shortest_path_query_only_tab_test_set.json")
    elif subtask == "shortest_path_only_map":
        data_file = os.path.join(base_dir, "metromap", "data", "test_set", "metromap_shortest_path_query_only_map_test_set.json")
    elif subtask == "shortest_path_map_and_tab_no_constraint":
        data_file = os.path.join(base_dir, "metromap", "data", "test_set", "metromap_shortest_path_query_map_and_tab_test_set.json")
    elif subtask == "shortest_path_map_and_tab_with_constraint_1":
        data_file = os.path.join(base_dir, "metromap", "data", "test_set", "metromap_shortest_path_query_map_and_tab_with_constraint_1_test_set.json")
    elif subtask == "shortest_path_map_and_tab_with_constraint_2":
        data_file = os.path.join(base_dir, "metromap", "data", "test_set", "metromap_shortest_path_query_map_and_tab_with_constraint_2_test_set.json")
    elif subtask == "shortest_path_map_and_tab_with_constraint_3":
        data_file = os.path.join(base_dir, "metromap", "data", "test_set", "metromap_shortest_path_query_map_and_tab_with_constraint_3_test_set.json")
    elif subtask == "shortest_path_map_and_tab_with_constraint_4":
        data_file = os.path.join(base_dir, "metromap", "data", "test_set", "metromap_shortest_path_query_map_and_tab_with_constraint_4_test_set.json")
    elif subtask == "shortest_path_map_and_tab_with_constraint_1_2_3_4":
        data_file = os.path.join(base_dir, "metromap", "data", "test_set", "metromap_shortest_path_query_map_and_tab_with_constraint_1_2_3_4_test_set.json")
    elif subtask == "shortest_path_map_and_tab_with_constraint_1_2_4":
        data_file = os.path.join(base_dir, "metromap", "data", "test_set", "metromap_shortest_path_query_map_and_tab_with_constraint_1_2_4_test_set.json")
    elif subtask == "shortest_path_map_and_tab_with_constraint_1_3_4":
        data_file = os.path.join(base_dir, "metromap", "data", "test_set", "metromap_shortest_path_query_map_and_tab_with_constraint_1_3_4_test_set.json")
    elif subtask == "shortest_path_map_and_tab_with_constraint_2_3_4":
        data_file = os.path.join(base_dir, "metromap", "data", "test_set", "metromap_shortest_path_query_map_and_tab_with_constraint_2_3_4_test_set.json")
    elif subtask == "only_vertex2":
        data_file = os.path.join(base_dir, "metromap", "data", "test_set", "metromap_shortest_path_query_map_and_tab_with_constraint_1_2_3_4_only_vertex2_test_set.json")
    ...
    # csv消融实验
        ...
        data_file = os.path.join(base_dir, "metromap", "qa_data", "metromap_4_qa_edge_tab_global.json")
    elif subtask == "5_csv_edge_part":
        data_file = os.path.join(base_dir, "metromap", "qa_data", "metromap_5_qa_edge_tab_part.json")
    elif subtask == "6_csv_edge_spatial_judge":
        data_file = os.path.join(base_dir, "metromap", "qa_data", "metromap_6_qa_edge_tab_spatial_judge.json")
    elif subtask == "7_csv_vertex_global":
        data_file = os.path.join(base_dir, "metromap", "qa_data", "metromap_7_qa_vertex_tab_global.json")
    elif subtask == "8_csv_vertex_part":
        data_file = os.path.join(base_dir, "metromap", "qa_data", "metromap_8_qa_vertex_tab_part.json")
    elif subtask == "9_csv_vertex_spatial_judge":
        data_file = os.path.join(base_dir, "metromap", "qa_data", "metromap_9_qa_vertex_tab_spatial_judge.json")
    elif subtask == "10_csv_and_pic_global":
        data_file = os.path.join(base_dir, "metromap", "qa_data", "metromap_10_qa_pic_and_tab_global.json")
    elif subtask == "11_csv_and_pic_part":
        data_file = os.path.join(base_dir, "metromap", "qa_data", "metromap_11_qa_pic_and_tab_part.json")
    elif subtask == "12_csv_and_pic_spatial_judge":
        data_file = os.path.join(base_dir, "metromap", "qa_data", "metromap_12_qa_pic_and_tab_spatial_judge.json")
        ...
        data_file = os.path.join(base_dir, "metromap", "qa_data", "metromap_1_qa_only_pic_global.json")
    elif subtask == "2_qa_only_pic_part":
        data_file = os.path.join(base_dir, "metromap", "qa_data", "metromap_2_qa_only_pic_part.json")
    elif subtask == "3_qa_only_pic_spatial_judge":
        data_file = os.path.join(base_dir, "metromap", "qa_data", "metromap_3_qa_only_pic_spatial_judge.json")
    ...
    elif subtask == "j_e_tab":
        data_file = os.path.join(base_dir, "metromap", "qa_data", "metromap_4_qa_edge_tab_global.json")
    elif subtask == "j_v_tab":
        data_file = os.path.join(base_dir, "metromap", "qa_data", "metromap_7_qa_vertex_tab_global.json")
    elif subtask == "j_v2_tab":
        data_file = os.path.join(base_dir, "metromap", "qa_data", "metromap_13_qa_vertex2_tab_global.json")

    elif subtask == "c_e_tab":
        data_file = os.path.join(base_dir, "metromap", "qa_data", "metromap_4_qa_edge_tab_global.json")
    elif subtask == "c_v_tab":
        data_file = os.path.join(base_dir, "metromap", "qa_data", "metromap_7_qa_vertex_tab_global.json")
    elif subtask == "c_v2_tab":
        data_file = os.path.join(base_dir, "metromap", "qa_data", "metromap_13_qa_vertex2_tab_global.json")
    ...
    if "with_constraint" in subtask:
        ...
        prompt_filename = f"metromap_shortest_path_with_constraint_{constraint_part}.txt"
    elif "qa_and_constraint" in subtask:
        # Extract the constraint part
        constraint_part = subtask.split("qa_and_constraint_")[-1]
        prompt_filename = f"metromap_shortest_path_with_qa_and_constraint_{constraint_part}.txt"
    elif "only_tab" in subtask or "only_csv" in subtask:
        prompt_filename = "metromap_shortest_path_only_tab.txt"
    elif "only_map" in subtask:
        prompt_filename = "metromap_shortest_path_only_map.txt"
    elif "no_constraint" in subtask or "map_and_csv" in subtask:
        prompt_filename = "metromap_shortest_path_map_and_tab.txt"
    elif "only_vertex2" in subtask:
        prompt_filename = "metromap_shortest_path_with_constraint_1_2_3_4_only_vertex2.txt"

    elif "csv_vertex2" in subtask:
        prompt_filename = "metromap_shortest_path_with_constraint_1_2_3_4_only_vertex2.txt"
    elif "csv_constraint" in subtask:
        prompt_filename = "metromap_shortest_path_with_constraint_1_2_3_4.txt"
    elif "4_csv_edge_global" in subtask:
        prompt_filename = "metromap_4_qa_edge_tab_global.txt"
    elif "5_csv_edge_part" in subtask:
        prompt_filename = "metromap_5_qa_edge_tab_part.txt"
    elif "6_csv_edge_spatial_judge" in subtask:
        prompt_filename = "metromap_6_qa_edge_tab_spatial_judge.txt"
    elif "7_csv_vertex_global" in subtask:
        prompt_filename = "metromap_7_qa_vertex_tab_global.txt"
    elif "8_csv_vertex_part" in subtask:
        prompt_filename = "metromap_8_qa_vertex_tab_part.txt"
    elif "9_csv_vertex_spatial_judge" in subtask:
        prompt_filename = "metromap_9_qa_vertex_tab_spatial_judge.txt"
    elif "10_csv_and_pic_global" in subtask:
        prompt_filename = "metromap_10_qa_pic_and_tab_global.txt"
    elif "11_csv_and_pic_part" in subtask:
        prompt_filename = "metromap_11_qa_pic_and_tab_part.txt"
    elif "12_csv_and_pic_spatial_judge" in subtask:
        prompt_filename = "metromap_12_qa_pic_and_tab_spatial_judge.txt"

    elif "1_qa_only_pic_global" in subtask:
        prompt_filename = "metromap_1_qa_only_pic_global.txt"
    elif "2_qa_only_pic_part" in subtask:
        prompt_filename = "metromap_2_qa_only_pic_part.txt"
    elif "3_qa_only_pic_spatial_judge" in subtask:
        prompt_filename = "metromap_3_qa_only_pic_spatial_judge.txt"
    ...
    elif "j_e_tab" in subtask:
        prompt_filename = "metromap_12_qa_pic_and_tab_spatial_judge.txt"
    elif "j_v_tab" in subtask:
        prompt_filename = "metromap_12_qa_pic_and_tab_spatial_judge.txt"
    elif "j_v2_tab" in subtask:
        prompt_filename = "metromap_12_qa_pic_and_tab_spatial_judge.txt"

    elif "c_e_tab" in subtask:
        prompt_filename = "metromap_12_qa_pic_and_tab_spatial_judge.txt"
    elif "c_v_tab" in subtask:
        prompt_filename = "metromap_12_qa_pic_and_tab_spatial_judge.txt"
    elif "c_v2_tab" in subtask:
        prompt_filename = "metromap_12_qa_pic_and_tab_spatial_judge.txt"
    ...
    prompt_file = os.path.join(base_dir, "metromap", "prompts", prompt_filename)
    ...
    if subtask == "shortest_path_only_tab":
        for item in datas:
            queries.append([
                ...
                ("text","This is an edge table of a subway map."),
        ...
        for item in datas:
            ...
            queries.append([
                ...
                ("text","This is a vertex table of a subway map."),
...
def test_build_metromap_queries():
    """测试 build_metromap_queries 函数"""
    print("=" * 60)
    print("测试 build_metromap_queries 函数")
    print("=" * 60)
    ...
    # 测试用例列表
    test_cases = [
        ("metromap", "shortest_path_only_tab"),
    ]
